...
#include <stdio.h>
#include <stdint.h>
#include "/usr/local/boson/include/ClientFiles_C/Client_API.h"
#include "/usr/local/boson/include/ClientFiles_C/EnumTypes.h"
#include "/usr/local/boson/include/ClientFiles_C/UART_Connector.h"
